...
function electronics_store_customize_register( $wp_customize ) {
	...
	//About Section
		...
		$wp_customize->add_control('electronics_store_demo_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Demo</h3>Our premium version of Electronics Store has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.<br> <a target='_blank' href='". esc_url('https://www.themescaliber.com/electronics-store-pro/') ." '>View Demo</a>",
		...
		$wp_customize->add_control('electronics_store_doc_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Documentation</h3>We have well prepared documentation that provides the general guidelines and suggestions needed for this theme.<br> <a target='_blank' href='". esc_url('https://themescaliber.com/demo/doc/free-electronics-store/') ." '>View Documentation</a>",
			'section'=> 'electronics_store_about_theme'
		));
		...
		$wp_customize->add_control('electronics_store_forum_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Support</h3>Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.<br><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/electronics-store/') ." '>Support Forum</a>",
			'section'=> 'electronics_store_about_theme'
		));
